(function () {
            ...
            try {
                ...
                appConfig = {
                    header: {
                        ...
                        subtitle: "31 大平台 智谱AI、Kimi、MiniMax、阿里·百炼、字节·方舟、小米·MiMo、OpenCode、Codex、Claude Code、百度·千帆、华为云、腾讯云、京东云，Coding Plan / Token Plan 全面对比。<br>支持DeepSeek V4，GLM-5.2，Qwen-3.7-Max，Kimi-K3，MiniMax-M3，Doubao-Seed-2.0，MiMo-V2.5-Pro，GPT-5.6等模型",
        ...
        async function ensureMonitorViewMounted() {
            ...
            if (!document.querySelector('link[data-monitor-css="1"]')) {
                ...
                link.rel = 'stylesheet';
                link.href = 'styles/monitor.css?v=260725f';
